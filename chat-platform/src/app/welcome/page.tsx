  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-indigo-950/20 to-gray-950 px-4 py-12">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-indigo-500/8 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        {/* Welcome Message */}
        <div className="glass rounded-2xl p-8 border border-indigo-500/20 mb-8">
          <h2 className="text-xl font-bold text-indigo-400 mb-4 text-center">نحن سعداء بانضمامك!</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={step.num} className="flex items-center gap-4 bg-gray-800/30 rounded-xl p-4">
                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  {step.num}
                </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
          <Link href="/chat-guide" className="glass rounded-xl p-4 text-center hover:border-indigo-500/30 border border-transparent transition-all">
            <div className="text-2xl mb-1">📖</div>
            <span className="text-gray-300 text-sm">دليل الدردشة</span>
          </Link>
          <Link href="/rules" className="glass rounded-xl p-4 text-center hover:border-indigo-500/30 border border-transparent transition-all">
            <div className="text-2xl mb-1">📋</div>
            <span className="text-gray-300 text-sm">القوانين</span>
          </Link>
          <Link href="/instructions" className="glass rounded-xl p-4 text-center hover:border-indigo-500/30 border border-transparent transition-all">
            <div className="text-2xl mb-1">📝</div>
            <span className="text-gray-300 text-sm">التعليمات</span>
          </Link>
          <Link href="/register" className="glass rounded-xl p-4 text-center hover:border-indigo-500/30 border border-transparent transition-all bg-gradient-to-br from-indigo-600/20 to-purple-600/20">
            <div className="text-2xl mb-1">🚀</div>
