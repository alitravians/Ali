  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#060B18] via-[#0A1128]/20 to-[#060B18] px-4 py-12">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        {/* Intro */}
        <div className="glass rounded-2xl p-6 border border-violet-500/20 mb-8 text-center">
          <p className="text-gray-300 leading-relaxed">
            مرحباً بك في <span className="text-violet-400 font-bold">ChatZone</span>. لضمان بيئة آمنة ومريحة ومحترمة لجميع الأعضاء،
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="w-6 h-6 rounded-full bg-violet-500/20 text-violet-400 flex items-center justify-center text-xs font-bold flex-shrink-0">
                      {i + 1}
                    </span>
        ...
        <div className="text-center space-x-4 space-x-reverse">
          <Link href="/chat-guide" className="text-violet-400 hover:text-indigo-300 transition-colors text-sm">
            دليل الدردشة
          </Link>
          ...
          <span className="text-gray-600">|</span>
          <Link href="/welcome" className="text-violet-400 hover:text-indigo-300 transition-colors text-sm">
            صفحة الترحيب
          </Link>
          <span className="text-gray-600">|</span>
