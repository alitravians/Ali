...
export default function AnalyzePage() {
  ...
  const handleAnalyze = useCallback(async () => {
    ...
    if (!hasApiKey) {
      setError("Please set your OpenAI API key in Settings first (click the key icon in the navbar).");
      return;
    }
    ...
    <div className="min-h-screen bg-gray-50 py-6 sm:py-10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Message Analysis</h1>
          <p className="text-gray-600">Paste a message or conversation to analyze and get a suggested reply</p>
        </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-6 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-600 mt-0.5">
                Click the Settings (key icon) in the navbar to set your OpenAI API key before analyzing messages.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 mb-6">
          ...
          <textarea
            ...
            placeholder={
              mode === "single"
                ...
                : "Paste the full conversation here (include who said what)..."
            }
            rows={8}
          ...
          {messageTranslation && (
            <div className="mt-3 bg-emerald-50 rounded-xl p-4 border border-emerald-100" dir="rtl">
              <p className="text-xs text-emerald-600 font-medium mb-1 text-right">ترجمة الرسالة:</p>
        ...
        {loading && (
          <div className="bg-white rounded-2xl border border-gray-200 p-10 text-center mb-6">
            ...
            <p className="text-gray-600 font-medium">Analyzing your message...</p>
          ...
          <div className="space-y-6">
            ...
            {!result.classification.needs_reply && (
              <div className="bg-gray-50 rounded-2xl border border-gray-200 p-6 text-center">
                <p className="text-gray-600 font-medium">No reply needed for this message</p>
