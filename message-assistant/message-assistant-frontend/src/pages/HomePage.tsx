...
const features = [
  {
    ...
    description: "AI-powered message classification that understands context, tone, and intent.",
    color: "from-blue-500 to-indigo-500",
  },
  {
    icon: Sparkles,
    title: "Reply Generation",
    description: "Get professionally crafted replies in 8 different styles to match any situation.",
    color: "from-purple-500 to-pink-500",
  },
  {
    icon: Languages,
    title: "Translation",
    description: "Translate messages and replies between English and Arabic instantly.",
    color: "from-emerald-500 to-teal-500",
  },
  {
    icon: Search,
    title: "Research Detection",
    description: "Identifies when a message requires research before responding.",
    color: "from-orange-500 to-red-500",
  },
  {
    icon: Shield,
    title: "Sensitivity Alerts",
    description: "Warns you when a message is sensitive and needs careful handling.",
    color: "from-amber-500 to-orange-500",
  },
  {
    icon: Zap,
    title: "Priority Detection",
    description: "Automatically detects urgent messages that need immediate attention.",
    color: "from-cyan-500 to-blue-500",
  },
];

const steps = [
  { step: "1", title: "Paste Your Message", description: "Copy any message from Discord or other sources" },
  { step: "2", title: "Analyze", description: "AI analyzes the message's type, tone, and intent" },
  { step: "3", title: "Get Your Reply", description: "Receive a professional reply ready to send" },
];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-indigo-100 mb-10 leading-relaxed max-w-2xl mx-auto">
              AI-powered message analysis that helps you understand, classify, and respond
              to messages professionally. Perfect for Discord and English communication.
            </p>
      ...
      <section className="bg-gray-50 py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Three simple steps to analyze any message and get a perfect reply</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {steps.map((s, i) => (
              <div key={i} className="text-center">
                <div className="w-14 h-14 mx-auto bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-xl font-bold mb-4 shadow-lg">
                  {s.step}
                </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Everything you need to handle messages like a pro</p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">8 Reply Styles</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Choose the perfect tone for every situation</p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {["Brief", "Professional", "Formal", "Friendly", "Technical", "Polite", "Direct", "Firm"].map(
              (style) => (
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-indigo-100 mb-8 text-lg">Start understanding and responding to messages with AI-powered precision.</p>
          <Link
            to="/analyze"
