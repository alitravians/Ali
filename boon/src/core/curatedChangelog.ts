...
export const CURATED_CHANGELOG: Readonly<Record<string, ReadonlyArray<CuratedItem>>> = {
    ...
    "boon-v0.4.0": [
        { kind: "added",    text: "[التفاعلية - مؤشّر كتابة بجانب اسم القناة عند كتابة أحد فيها (Servers + DMs)]" },
        { kind: "improved", text: "[البنية - أساس داخلي جديد يفتح الباب لميزات تفاعلية متقدّمة]" },
    ],
    "boon-v0.3.0": [
        { kind: "added",    text: "[سجل الرسائل - حفظ الرسائل المحذوفة والمعدّلة مع شارة على الرسائل المعدَّلة]" },
        { kind: "added",    text: "[تكبير الصور - عدسة تكبير بالماوس + عجلة على أي صورة]" },
        { kind: "added",    text: "[نسخ الروابط - زر يميني لنسخ روابط المستخدمين/القنوات/السيرفرات مباشرة]" },
        { kind: "added",    text: "[مؤشّر الجهاز - أيقونات 🖥️/📱/🌐 بجانب المستخدمين تبيّن جهازهم]" },
        { kind: "added",    text: "[من تفاعل - tooltip بعدد المتفاعلين عند تحويم الماوس فوق إيموجي التفاعل]" },
        { kind: "added",    text: "[عدّاد الأعضاء - عدد الأعضاء المتصلين/الكلّي في رأس القناة]" },
        { kind: "added",    text: "[مؤقّت المكالمات - عدّاد HH:MM:SS داخل قنوات الصوت]" },
        { kind: "added",    text: "[المحتوى الخام - عرض JSON الكامل لأي رسالة مع زر نسخ]" },
        { kind: "added",    text: "[محرّر CSS - Ctrl+Alt+C لمحرّر CSS مباشر يطبّق فوراً بدون إعادة تشغيل]" },
    ],
    "boon-v0.2.5": [
