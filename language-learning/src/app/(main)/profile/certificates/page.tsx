            ...
            <div className="p-6">
              ...
              >
                ...
                <div className="flex justify-between items-end mt-4 text-xs text-gray-500">
                  ...
                  <div>
                    {/* Official Seal */}
                    <div className="w-20 h-20 border-4 border-primary-300 rounded-full flex items-center justify-center mx-auto">
                      <div className="text-center">
                        <p className="text-[8px] font-bold text-primary-600">LinguaMaster</p>
                        <p className="text-lg">{getLevelStyle(selectedCert.level.order).seal}</p>
                        <p className="text-[8px] text-primary-500">VERIFIED</p>
                      </div>
                    </div>
                  </div>
                  <div>
