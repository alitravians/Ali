...
async function main() {
  ...
  const defaultItems = [
    ...
    },
    {
      ...
      name: "Stars Effect",
      nameAr: "تأثير النجوم",
      description: "Twinkling stars animation when entering chat",
      descriptionAr: "نجوم متلألئة عند دخول الدردشة",
      type: "entry_effect",
      icon: "⭐",
      color: "#60a5fa",
      previewData: JSON.stringify({ effect: "stars", rarity: "rare" }),
      rarity: "rare",
      order: 3,
    },
    {
      ...
      name: "Fire Effect",
      nameAr: "تأثير النار",
      description: "Rising flames animation when entering chat",
      descriptionAr: "ألسنة لهب عند دخول الدردشة",
      type: "entry_effect",
      icon: "🔥",
      color: "#ef4444",
      previewData: JSON.stringify({ effect: "fire", rarity: "rare" }),
      rarity: "rare",
      order: 4,
    },
    {
      id: "item-legendary-effect",
      name: "Legendary Effect",
      nameAr: "تأثير أسطوري",
      description: "Epic legendary animation when entering chat",
      descriptionAr: "تأثير أسطوري خرافي عند دخول الدردشة",
      type: "entry_effect",
      icon: "🐉",
      color: "#a855f7",
      previewData: JSON.stringify({ effect: "legendary", rarity: "legendary" }),
      rarity: "legendary",
      order: 5,
    },
    {
      id: "item-royal-effect",
      name: "Royal Frame Effect",
      nameAr: "تأثير الإطار الملكي",
      description: "Royal golden frame animation when entering chat",
      descriptionAr: "إطار ملكي ذهبي عند دخول الدردشة",
      type: "entry_effect",
      icon: "👑",
      color: "#eab308",
      previewData: JSON.stringify({ effect: "royal", rarity: "legendary" }),
      rarity: "legendary",
      order: 6,
    },
    {
      ...
      name: "Neon Effect",
      nameAr: "تأثير النيون",
      description: "Pulsing neon lights animation",
      descriptionAr: "إضاءة نيون نابضة عند دخول الدردشة",
      type: "entry_effect",
      icon: "💜",
      color: "#8b5cf6",
      previewData: JSON.stringify({ effect: "neon", rarity: "uncommon" }),
      rarity: "uncommon",
      order: 7,
    },
    {
      ...
      name: "Snow Effect",
      nameAr: "تأثير الثلوج",
      description: "Seasonal snow falling animation",
      descriptionAr: "ثلوج موسمية متساقطة عند دخول الدردشة",
      type: "entry_effect",
      icon: "❄️",
      color: "#bae6fd",
      previewData: JSON.stringify({ effect: "seasonal_snow", rarity: "rare" }),
      category: "seasonal",
      rarity: "rare",
      order: 8,
    },
