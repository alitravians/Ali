...
export const sources: Source[] = [
  ...
  { id: 'devin_ai', name: 'تحليلات الأنظمة', nameAr: 'تحليلات الأنظمة التلقائية', type: 'technical', trustLevel: 'high', url: 'https://devin.ai', lastUpdate: new Date(), isActive: true, eventCount: 0 },
];
