...
export function AdminLoginDialog() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Form data prepared:', { username })
      ...
      {open && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4" style={{ pointerEvents: 'none' }}>
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-auto transform transition-all" style={{ pointerEvents: 'auto' }}>
