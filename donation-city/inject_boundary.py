#!/usr/bin/env python3
# ──────────────────────────────────────────────────────────────────────────
# Injector: City boundary system (invisible wall + gold fence + fall rescue).
#   Adds/updates Script "BoundarySystem" in ServerScriptService
#   (source = src/BoundarySystem.server.lua).
#
...
SCRIPTS = [
    ("Script", "BoundarySystem", "BoundarySystemRef",
     os.path.join(HERE, "src", "BoundarySystem.server.lua"), "ServerScriptService"),
]
