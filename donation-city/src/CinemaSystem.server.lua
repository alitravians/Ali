...
local function setupPostFX()
	...
	if not Lighting:FindFirstChild("CinemaBloom") then
		-- Bloom خفيف جداً: حجم صغير + عتبة أعلى، فلا يتمدّد أي نيون لشريط عريض يغطّي الشاشة.
		local bloom = Instance.new("BloomEffect")
		bloom.Name = "CinemaBloom"; bloom.Intensity = 0.32; bloom.Size = 6; bloom.Threshold = 2.0
