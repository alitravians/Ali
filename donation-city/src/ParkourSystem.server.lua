...
local function runEntryScan(player)
	...
	pcall(function()
		...
		-- صوت المسح الضوئي: صوت ثلاثي الأبعاد يصدر من قرص المسح وينزل معه فيسمعه
		-- كل القريبين. عند انتهاء المسح يُسلَّم لمصدر ثابت (أدناه) كي يُكمل تشغيله
		-- دون قطع مفاجئ مهما طال، ثم يُنظَّف ذاتياً
		snd = Instance.new("Sound")
		snd.Name = "ScanSound"
		snd.SoundId = "rbxassetid://76270469261531"
		snd.Volume = 1
