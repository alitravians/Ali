...
local function runEntryScan(player)
	...
	if hrp then wasAnchored = hrp.Anchored; hrp.Anchored = true end
	if hum then hum.PlatformStand = true end

	local rig = Instance.new("Model"); rig.Name = "GateScanFX"; rig.Parent = gate
	-- يُغلّف العرض بـpcall لضمان فكّ تثبيت اللاعب وهدم المؤثّر حتى لو حصل خطأ
	pcall(function()
