...
task.spawn(function()
	-- موضع الموظف عند كاونتر لوبي السينما (يسار المدخل)،
	-- مواجهاً اللاعبين القادمين من المدخل (+Z). مبتعد عن بسطة الفشار/الخادم.
	local bx, bz = -8, -104
	local target = Vector3.new(bx, GROUND_Y, bz)

	-- نضع الموظف الجاهز (الجالس على كرسيّه) عند كاونتر اللوبي ونربط زر الشراء به
	local cashier = buildCashierModel({
		...
		target = target, faceDir = Vector3.new(0, 0, 1),   -- يواجه اللاعبين القادمين من المدخل (+Z)
