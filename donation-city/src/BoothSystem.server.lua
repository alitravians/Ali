...
local function indexBooth(key: string)
	...
	if body then
		...
		piece("ChairSeatGlow", 2.45, 0.10, 0.12, 0, 1.40, 1.82, accent, Enum.Material.Neon)
		...
		piece("ChairLumbarGlow", 1.75, 0.12, 0.30, 0, -0.74, 2.60, accent, Enum.Material.Neon, recline)

		-- (5) مسند الرأس + لمسة Neon
		piece("ChairHead", 1.55, 0.50, 0.78, 0, -1.05, 5.05, COL_LEATHER, Enum.Material.SmoothPlastic, recline)
		piece("ChairHeadGlow", 1.25, 0.10, 0.12, 0, -0.85, 5.20, accent, Enum.Material.Neon, recline)
