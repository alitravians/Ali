...
local CONFIG = {
	...
	MenuVersion   = "الإصدار ٢.٩.٤٤",          -- يظهر أسفل القائمة
	...
	UpdatesLog = {
		{
			version = "٢.٩.٤٤", date = "٢٨ يونيو",
			items = {
				{ "fix", "إصلاح جذري للطيران على الجوال: أضفنا عصا تحكّم خاصة بالطيران على يسار الشاشة — صار اللاعب يتحرّك أفقياً بدل ما يبقى ثابتاً." },
			},
		},
		{
