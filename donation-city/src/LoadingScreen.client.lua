	...
	UpdatesLog = {
		{
			...
			items = {
				{ "fix", "إصلاح جذري ونهائي لمشكلة «Waiting for an available server»: أداة النشر التلقائي صارت تُحوّل ملف اللعبة إلى صيغة Roblox الثنائية النظيفة (rbxl) وتوحّد أنواع الخصائص تماماً مثل ما يسوي Studio قبل الرفع، فما عاد يُرفع ملف XML غير متطابق يكسر السيرفرات." },
			},
		},
		{
