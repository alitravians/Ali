...
local CONFIG = {
	...
	BackgroundImageId      = 80412693584456, -- خلفية القائمة الرئيسية (شفق قطبي، Decal جديد) — النافورة تبقى بصورتها الأصلية
	...
	MenuVersion   = "الإصدار ٢.٩.٢٩",          -- يظهر أسفل القائمة
	...
	UpdatesLines = {
		"🎯 تحديث ٢.٩.٢٩ — تركيز على المهام والتحديات:",
		"• الواجهة صارت تبرز «📋 المهام» والباركور كنشاط رئيسي.",
		"• نافذة إكمال الباركور تعرض «أفضل وقت» وشارة الرقم القياسي 🏆.",
		"• رسائل الترحيب والدليل تركّز على المهام والتحديات والأنشطة.",
		"",
		...
		"",
		"⭐ VIP والمقاعد:",
		"• عضوية VIP (Robux أو كوينز): تذاكر بنص السعر وتاج ودخل مضاعف.",
