...
local CONFIG = {
	...
	MenuVersion   = "الإصدار ٢.٩.٣٢",          -- يظهر أسفل القائمة
	...
	UpdatesLog = {
		{
			version = "٢.٩.٣٢", date = "٢٨ يونيو",
			items = {
				{ "improve", "لافتة «أفضل وقت» عند برج الباركور بحُلّة ملكية: زجاج داكن + إطار وتاج ذهبي + شريحة." },
				{ "fix", "إصلاح بقاء توهّج الخط الفائز في طاولة X·O بين الجولات." },
			},
		},
		{
