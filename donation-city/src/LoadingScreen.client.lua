...
local CONFIG = {
	...
	MenuVersion   = "الإصدار ٢.٩.٧٤",          -- يظهر أسفل القائمة
	...
	UpdatesLog = {
		{
			version = "٢.٩.٧٤", date = "٢٩ يونيو",
			items = {
				{ "fix", "إزالة لعبة الشطرنج مؤقتاً لأنها كانت تمنع فتح سيرفرات اللعبة — رجعت اللعبة تفتح طبيعي لكل اللاعبين." },
			},
		},
		{
