...
local CONFIG = {
	...
	MenuVersion   = "الإصدار ٢.٩.٣٨",          -- يظهر أسفل القائمة
	...
	UpdatesLog = {
		{
			...
			items = {
				{ "fix", "ضبط حاجز حافة المدينة: صار يُقاس تلقائياً على حدود الماب الفعلية فيلتفّ عند آخر نقطة أرض، بدل ما يوقف اللاعب في النص." },
			},
		},
		{
