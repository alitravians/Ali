...
local CONFIG = {
	...
	MenuVersion   = "الإصدار ٢.٩.٩٧",          -- يظهر أسفل القائمة
	...
	UpdatesLog = {
		{
			...
			items = {
				{ "fixed", "إصلاح جذري لشاشة لابتوب مكتب الإدارة: صارت الشاشة تقف باتجاه الكرسي بدون أي ميلان جانبي، وخلفية الشاشة تركب على وجهها تماماً وبنسبة أبعاد صحيحة بلا قصّ." },
			},
		},
		{
