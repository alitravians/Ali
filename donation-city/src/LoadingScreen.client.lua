...
local CONFIG = {
	...
	MenuVersion   = "الإصدار ٣.٠.٥",          -- يظهر أسفل القائمة
	...
	UpdatesLog = {
		{
			...
			items = {
				...
				{ "new", "تشغيل منصّات الأدوات داخل البرج: كف الصفع، القنبلة المرحة، والبساط الملوّن — أدوات حقيقية تلمسها فتمتلكها." },
				{ "new", "تفعيل ميكانيكيات البرج كاملة: أجزاء مختفية، منصّات قفز، أرضيات جليدية، بوّابات نقل سرّية، وأزرار الخدعة." },
		...
		},
		{
			...
			items = {
				...
				{ "new", "تقييد واقعي: المكلبش تنقيّد يداه خلف ظهره فعلياً وتبقى مقيّدة حتى أثناء المشي والسحب، مع انحناءة خفيفة للجذع تحاكي الشخص المقيّد." },
			},
		},
		{
		...
		{
			version = "٢.٩.٨٥", date = "٣ يوليو",
			items = {
				{ "new", "مظلة النزول أعيد تصميمها ثلاثي الأبعاد باحترافية: قطاعات كحلي وذهبي بارزة، حافة مفصّصة، حبال واضحة تتجمّع على حلقة تعليق، وفتحة ذهبية بالقمّة." },
			},
		},
		{
			version = "٢.٩.٨٤", date = "٣ يوليو",
			items = {
				{ "new", "تحسين مظلة النزول: رياح متصاعدة، صوت فتح المظلة، صوت هبوط، تباطؤ واضح عند الفتح، اهتزاز خفيف، ظل ديناميكي، وغبار هبوط ناعم." },
			},
		},
		{
			version = "٢.٩.٨٣", date = "٢٩ يونيو",
			items = {
				{ "fix", "إصلاح ظهور الكلبشات باليد: الأداة صارت تنتظر وصول الموديل ثلاثي الأبعاد وتركّبه فور وصوله، مع شكل احتياطي فوري فلا تظهر اليد فاضية أبداً." },
			},
		},
		{
			version = "٢.٩.٨٢", date = "٢٩ يونيو",
			items = {
				{ "fix", "إصلاح جذري لمشكلة تعليق الدخول (انتظار سيرفر متاح) — صار موديل الكلبشات يُحمَّل مباشرة من روبلوكس وقت التشغيل بدل تضمينه في ملف اللعبة." },
			},
		},
		{
			version = "٢.٩.٨١", date = "٢٩ يونيو",
			items = {
				{ "new", "شاشة اللابتوب في المكتب الرئاسي بالقصر صارت تعرض خلفية حقيقية بدل التوهج الأزرق." },
			},
		},
		{
			version = "٢.٩.٨٠", date = "٢٩ يونيو",
			items = {
				{ "new", "تصميم كلبشات جديد كلياً: موديل أصفاد معدنية واقعية بحلقات وسلسلة حقيقية يظهر بيدك عند تجهيز الكلبشة، ويلتفّ على معصمي اللاعب المكلبش بلون كلبشتك المختارة." },
			},
		},
		{
			version = "٢.٩.٧٩", date = "٢٩ يونيو",
			items = {
				{ "new", "أضفنا إنارة مدخل ركن الألعاب على شكل كشافات مسرح متحرّكة بتوهّج أنيق وأشعة ملوّنة تتأرجح فوق الباب وتعطي المكان طابعاً فخماً." },
			},
		},
		{
			version = "٢.٩.٧٨", date = "٢٩ يونيو",
			items = {
				{ "new", "متجر الكلبشات صار Game Pass بالروبكس: ست كلبشات حصرية (الملكية · الظل · اللهب · النيون · الجليد · القلوب) تُشترى مرة وتبقى لك للأبد، وتقيّد اللاعب القريب وتسحبه ولا تنفكّ إلا لما تفكّها أنت." },
			},
		},
		{
			version = "٢.٩.٧٧", date = "٢٩ يونيو",
			items = {
				{ "new", "أضفنا الكلبشات: ستة أساليب حصرية مع تجهيز واستخدام ميداني لتقييد اللاعبين عن بُعد القريب، مع مظهر عربي أنيق وسلسلة جرّ مرئية." },
			},
		},
		{
			version = "٢.٩.٧٦", date = "٢٩ يونيو",
			items = {
				{ "fix", "عادت اللعبة تفتح بثبات وسرعة للجميع بعد حل مشكلة الدخول التي كانت تعلّق على شاشة الانتظار." },
				{ "feature", "لعبة الشطرنج ثلاثية الأبعاد متوفّرة في ركن الألعاب — اجلس على الكرسي وابدأ مباراة كاملة القواعد بقطع مجسّمة." },
			},
		},
		{
			version = "٢.٩.٧٥", date = "٢٩ يونيو",
			items = {
				{ "fix", "إصلاح جذري لأداة النشر: تصحيح نوع محتوى الملف عند رفعه لروبلوكس، وهو السبب الحقيقي لمشكلة «Waiting for an available server». رجعت لعبة الشطرنج وكل الأنظمة تعمل طبيعي." },
			},
		},
		{
			version = "٢.٩.٧٣", date = "٢٩ يونيو",
			items = {
				{ "fix", "إعادة نشر لتنشيط السيرفرات وفتح سيرفر جديد بأحدث نسخة (معالجة مشكلة «Waiting for an available server»)." },
			},
		},
		{
			version = "٢.٩.٧٢", date = "٢٩ يونيو",
			items = {
				{ "fix", "الشطرنج: إصلاح مربّع فارغ (⬜) كان يظهر جنب عدّادات الأسر بسبب رموز القطع (♔/♚) غير المدعومة في الخط — استبدلناها برموز تُعرَض بوضوح (⚪ أبيض / ⚫ أسود)." },
			},
		},
		{
			version = "٢.٩.٧١", date = "٣٠ يونيو",
			items = {
				{ "feature", "الشطرنج أصبح أكثر واقعية: حركة بقوس ترفع القطعة (والحصان يقفز أعلى) + توهّج آخر نقلة + مؤشّر الكش النابض + صينية أسرى جانبية + اهتزاز القطعة المختارة + ومضة ترقية." },
				{ "feature", "الشطرنج: أصوات واقعية متنوّعة — نقلة، أسر، تبييت، كش، ترقية، ونهاية المباراة." },
			},
		},
		{
			version = "٢.٩.٧٠", date = "٣٠ يونيو",
			items = {
				{ "fix", "الشطرنج: عند خروج لاعب أثناء المباراة تُصفّر الآن عدّادات الأسر وسطر «آخر نقلة» بدل بقائها بقيم قديمة مضلّلة." },
			},
		},
		{
			version = "٢.٩.٦٩", date = "٣٠ يونيو",
			items = {
				{ "fix", "إعادة نشر للتأكد من تحديث السيرفرات وفتح سيرفر جديد بأحدث نسخة." },
			},
		},
		{
			version = "٢.٩.٦٨", date = "٢٩ يونيو",
			items = {
				{ "fix", "تعزيز متانة تحميل قطع الشطرنج: صارت القوالب تُحفظ في مجلد ثابت بدل الاعتماد على سلوك غير موثَّق بعد إتلاف النموذج — فالقطع تظهر دائماً بثبات. (مع دمج تحديثات لوحة الإدارة والساعة في فرع الشطرنج.)" },
			},
		},
		{
			version = "٢.٩.٦٧", date = "٢٩ يونيو",
			items = {
				{ "fix", "إصلاح توهّج المربّعات في الشطرنج: كان توهّج المربّع المحدَّد يبقى عالقاً بعد كل اختيار فتتراكم بقع صفراء على اللوح؛ الحين يُمسَح بالكامل بعد كل نقلة." },
			},
		},
		{
			version = "٢.٩.٦٦", date = "٢٩ يونيو",
			items = {
				{ "fix", "إصلاح اتجاه كراسي الشطرنج: صار اللاعب يجلس مواجهاً اللوح مباشرةً بدل ما يجلس بظهره له." },
				{ "fix", "إصلاح لوحات حالة الشطرنج: كانت تواجه الجهة الخلفية فيُقرأ نصّها معكوساً عبر الزجاج، الحين تواجه اللاعبين والنص واضح وصحيح." },
			},
		},
		{
			version = "٢.٩.٦٥", date = "٢٩ يونيو",
			items = {
				{ "new", "♟ ثلاث طاولات شطرنج بدل وحدة! صار في «منطقة الشطرنج» ثلاث طاولات متجاورة بحجم متناسق مع المكان، كل طاولة مستقلّة بلعبتها ومقعَدين ولوحة حالة — فيقدر أكثر من زوج لاعبين يلعبون بنفس الوقت." },
				{ "fix", "إصلاح اتجاه اللافتات: كانت الكتابة تظهر مقلوبة من إحدى الجهتين، الحين تُقرأ صحيحةً من الأمام والخلف." },
			},
		},
		{
			version = "٢.٩.٦٤", date = "٢٩ يونيو",
			items = {
				{ "new", "♟ لعبة الشطرنج وصلت ركن الألعاب! لوح 8×8 ثلاثي الأبعاد بقطع Staunton مجسّمة (ملك، وزير، رخ، فيل، حصان، بيدق) بلونين أبيض وأسود. اجلس على كرسيّ تنضمّ، انقر قطعتك فتُبرَز نقلاتك القانونية (نقاط خضراء + حلقات حمراء للأسر) ثم انقر الوجهة فتنتقل بنعومة." },
				{ "new", "محرّك شطرنج احترافي كامل: كل الحركات القانونية + كش/كش مات/تعادل + تبييت + أخذ بالمرور + ترقية البيدق، ومنع أي نقلة تترك ملكك في كش — مُتحقَّق منه باختبار perft الدولي." },
				{ "new", "إعادة ترتيب ركن الألعاب: «منطقة إكس-أو» يسار الصالة و«منطقة الشطرنج» يمينها، كلٌّ بمساحته ولافتته، مع فاصل أوسط أنيق." },
			},
		},
		{
			version = "٢.٩.٦٣", date = "٢٩ يونيو",
			items = {
				{ "new", "تحسين احترافي للعبة إكس-أو (X-O): رموز أنعم (O حلقة ملساء + X بأطراف مدوّرة) + أنيميشن انبثاق ناعم عند وضع الرمز + إبراز خط الفوز بشعاع نابض + أصوات (نقرة عند اللعب ونغمة فوز) + عدّاد نتيجة X و O على لوحة الطاولة." },
			},
		},
		{
			version = "٢.٩.٦٢", date = "٢٩ يونيو",
			items = {
				{ "fix", "إصلاح خلل وميض الدائرة المتوهّجة حول بوابة برج الباركور (أذرع الضوء الثلاثة كانت متطابقة فتومض) + تخفيف الوهج الأبيض الزائد على المنصّة — صارت أوضح وأريح للعين." },
			},
		},
		{
			version = "٢.٩.٦١", date = "٢٩ يونيو",
			items = {
				{ "fix", "إزالة أشجار الكرز الأربع التي ظهرت داخل مبنى «ركن الألعاب» خطأً — بقيت أشجار الكرز الخارجية فقط." },
			},
		},
		{
